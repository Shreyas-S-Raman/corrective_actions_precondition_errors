...
def arm_trajectory(config):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        hand_pose1 = math_helpers.SE3Pose(x=x1, y=y1, z=z, rot=rotation)
        hand_pose2 = math_helpers.SE3Pose(x=x2, y=y1, z=z, rot=rotation)
        hand_pose3 = math_helpers.SE3Pose(x=x3, y=y1, z=z, rot=rotation_roll)
        ...
        # Build the trajectory proto by combining the points.
        hand_traj = trajectory_pb2.SE3Trajectory(points=[traj_point4, traj_point5])
        ...
        command_client, stow_command_id,10.0)
