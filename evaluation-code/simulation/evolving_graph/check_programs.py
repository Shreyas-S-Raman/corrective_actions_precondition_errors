...
def check_one_program(helper, script, precond, graph_dict, w_graph_list, modify_graph=True, place_other_objects=True, id_mapping={}, **info):
    ...
    if modify_graph:
        ...
        id_mapping, new_obj_ids, first_room, ____ = helper.add_missing_object_from_script(script, precond, graph_dict, id_mapping, info['room_mapping'])
        ...
        helper.prepare_from_precondition(precond, id_mapping, graph_dict, new_objects_in_script, True)
